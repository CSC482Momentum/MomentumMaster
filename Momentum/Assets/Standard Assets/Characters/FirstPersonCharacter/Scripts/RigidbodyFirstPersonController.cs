...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : NetworkBehaviour
    {
        ...
        public void AddForceToLocal(Vector3 amount, ForceMode type)
        {
            CmdAddForce(amount, type);
        }

        [Command]
        public void CmdSetDrag(float newDrag)
        {
           this.drag = newDrag;
